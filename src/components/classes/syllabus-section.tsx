  ...
  return (
    <section className="mb-12">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <span className="inline-flex items-center gap-2 rounded-full border border-sky-400/20 bg-sky-400/5 px-4 py-1.5 text-xs font-medium text-sky-300">
          ...
          return (
            <div key={subject.name} className="glass-card overflow-hidden rounded-2xl">
              <Link
                ...
                className="flex items-center gap-3 border-b border-sky-400/10 bg-sky-400/5 px-5 py-3 transition-colors hover:bg-sky-400/10"
              >
                <BookMarked className="h-4 w-4 text-orange-400" />
                <h3 className="font-semibold text-white">{subject.name}</h3>
                <span className="ml-auto flex items-center gap-1 text-xs text-sky-300/50">
      ...
      <p className="mt-4 text-xs text-sky-300/40">
