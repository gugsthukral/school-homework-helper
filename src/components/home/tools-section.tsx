      ...
      <SiteContainer>
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {aiTools.map((tool) => (
            <div
              key={tool.name}
              className="home-card group flex h-full flex-col rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              ...
              <Link
                href={tool.href}
                className="home-link-action mt-5 inline-flex items-center gap-1 text-sm transition-transform group-hover:gap-2"
              >
                Try now
